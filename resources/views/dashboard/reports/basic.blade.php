    ...
    <div lang="ar">
        <table class="blueTable">
            <thead>
                ...
                <tr>
                    <td colspan="10" align="center" style="color: #000;border:0;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$record[1]}}</td>
                    <td style="white-space: nowrap;">{{$record[2]}}</td>
                    <td>{{$record[3]}}</td>
                    <td>{{$record[4]}}</td>
                    <td>{{$record[5]}}</td>
                    <td>{{$record[6]}}</td>
                    <td>{{$record[7]}}</td>
                    <td style="white-space: nowrap;">{{$record[8]}}</td>
                    <td style="white-space: nowrap;">{{$record[9]}}</td>
                    <td>{{$record[10]}}</td>
                </tr>
            @endforeach
            </tbody>
